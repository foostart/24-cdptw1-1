            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="block">
                            <div class="image">
                                <img src="images/1.jpg" alt="Beat Spill 2.0 Wireless Speaker - White" class="img-responsive"/>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="block">
                            <div class="image">
                                <img src="images/2.jpg" alt="Samsung Gear VR Virtual Reality Headset" class="img-responsive"/>
                            </div>
                            <div class="product-btn row">
                                <div class="product-list">
                                    <div class="col-md-3">
                    ...
                    <div class="swiper-slide">
                        <div class="block">
                            <div class="image">
                                <img src="images/3.jpg" alt="ASUS Chromebook Flip - 10.2 Inch" class="img-responsive"/>
                            </div>
                            <div class="product-btn row">
                                <div class="product-list">
                                    <div class="col-md-3">
                    ...
                    <div class="swiper-slide">
                        <div class="block">
                            <div class="image">
                                <img src="images/5.jpg" alt="Apple Macbook Display 12 Inch" class="img-responsive"/>
                            ...
                            <div class="price">
                                <span class="price-items">$500.00</span>
                    ...
                    <div class="swiper-slide">
                        <div class="block">
                            <div class="image">
                                <img src="images/6.jpg" alt="Xbox One Wireless Controller" class="img-responsive"/>
                            </div>
                            <div class="product-btn row">
                                <div class="product-list">
                                    <div class="col-md-3">
