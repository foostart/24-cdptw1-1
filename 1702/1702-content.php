           ...
           <div class="swiper-container">
              <div class="swiper-wrapper">
                 <div class="swiper-slide">
                    <div class="block">
                       <div class="image">
                          <img src="images/3.jpg" alt="Beat Spill 2.0 Wireless Speaker - White"/>
                       </div>
                 ...
                 <div class="swiper-slide">
                    <div class="block">
                       <div class="image">
                          <img src="images/3.jpg" alt="Samsung Gear VR Virtual Reality Headset"/>
                       </div>
                       <div class="product-btn row">
                          <div class="product-list">
                             <div class="col-md-3 col-sm-3 col-xs-3">
                 ...
                 <div class="swiper-slide">
                    <div class="block">
                       <div class="image">
                          <img src="images/3.jpg" alt="Apple iPhone Retina 6s Plus 64GB"/>
                       </div>
                       <div class="product-btn row">
                          <div class="product-list">
                             <div class="col-md-3 col-sm-3 col-xs-3">
                 ...
                 <div class="swiper-slide">
                    <div class="block">
                       <div class="image">
                          <img src="images/3.jpg" alt="Apple Macbook Display 12 Inch"/>
                       </div>
                       <div class="product-btn row">
                          <div class="product-list">
                             <div class="col-md-3 col-sm-3 col-xs-3">
                 ...
                 <div class="swiper-slide">
                    <div class="block">
                       <div class="image">
                          <img src="images/3.jpg" alt="Xbox One Wireless Controller"/>
                       </div>
                       <div class="product-btn row">
                          <div class="product-list">
                             <div class="col-md-3 col-sm-3 col-xs-3">
